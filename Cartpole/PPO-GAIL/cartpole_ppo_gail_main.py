...
def serial_pipeline_gail(
    ...
    # evaluator_env.enable_save_replay(replay_path='cartpole_ppo_gail_seed0/video')
...
if __name__ == '__main__':
    ...
    # from ding.entry import collect_demo_data, serial_pipeline

    # expert_policy = serial_pipeline([cartpole_ppo_offpolicy_config, cartpole_ppo_offpolicy_create_config], seed=0)

    # collect_count = 10000  # number of transitions to collect
    # expert_data_path = 'expert_data.pkl'  # data path to be saved
    # state_dict = expert_policy.collect_mode.state_dict()
    # collect_config = [deepcopy(cartpole_ppo_offpolicy_config), deepcopy(cartpole_ppo_offpolicy_create_config)]
    # collect_config[0].exp_name = 'cartpole_ppo_gail_collect'
    # collect_demo_data(
    #     collect_config, seed=0, state_dict=state_dict, expert_data_path=expert_data_path, collect_count=collect_count
    # )

    from cartpole_ppo_gail_config import main_config, create_config
